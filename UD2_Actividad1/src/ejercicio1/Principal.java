...
public class Principal {
    public static void main(String[] args) throws InterruptedException {
         ...
         * ▪ Muestre información acerca de él: identificador, nombre, estado y
         * prioridad.
         * ▪ Cambiar el nombre, la prioridad del hilo y detén la ejecución durante dos
         * segundos
         * ▪ Vuelve a mostrar sus datos llamando al método toString()
         * Este programa no tiene que crear ningún hilo, solo mostrar información sobre
         * el hilo actualmente en ejecución.
         */

        // Hilo actualmente en ejecución.
        Thread hiloPrincipal = Thread.currentThread();

        // Mostrando en pantalla informacion del hilo
        ...
        // Modificamos informacion del hilo
        hiloPrincipal.setName("PSP");
        hiloPrincipal.setPriority(10); // Prioridad entre 1 y 10 -MIN y NAX
